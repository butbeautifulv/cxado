  ...
  if (embedded) {
    return (
      <div className="flex min-w-0 flex-1 flex-col gap-3">
        <div className="h-8 w-full max-w-md animate-pulse rounded-gui-muted bg-muted/40" />
        <div className="h-6 w-full max-w-xl animate-pulse rounded-gui-muted bg-muted/40" />
      </div>
    )
  }

  return <div className="h-24 animate-pulse rounded-gui-control border bg-muted/40" />
}
