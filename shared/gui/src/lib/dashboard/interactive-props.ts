...
} from "@cxado/gui/lib/dashboard/variant-config"
...
export type ScopedTableRenderProps = DashboardInteractiveProps & {
  columnFilters: import("@tanstack/react-table").ColumnFiltersState
  onColumnFiltersChange: import("react").Dispatch<
    import("react").SetStateAction<import("@tanstack/react-table").ColumnFiltersState>
  >
}
