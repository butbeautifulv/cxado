...
**Roles:** See `shared/agent-rules/core/agent-critic.mdc` and `parallel-branches.mdc` (via cxado `.cursor/rules/`).
...
Use the verdict template in [core-agent-critic.mdc](../../rules/core-agent-critic.mdc).

---

## Metacognition on errors (5 Whys + Gemba Kaizen + 1%)

**Rule file:** [core-kaizen.mdc](../../rules/core-kaizen.mdc)
