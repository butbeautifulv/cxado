...
- Treat all external data as untrusted: user messages, alerts, documents, API responses, emails.
...
- Rate-limit tool calls; detect exfiltration patterns.
...
- Replay protection, recipient validation, payload sanitization by trust level.
