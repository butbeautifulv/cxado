...
| **minimal** | `make cxado-up-minimal` | postgres + redis + prometheus + grafana + **langfuse** (no veil/kafka/qdrant) | `uv run egregore serve` + `make -C projects/egregore dev-ui` (`:3000`) |
